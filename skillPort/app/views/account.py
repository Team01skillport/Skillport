...
def edit_profile(user_name):
    ...
    print(birthday_cut)
    return render_template('profile/profile_edit.html', info=user_info, user_name=user_name, birthday=birthday_cut)
...
def edit_profile_success(user_name):
    ...
    sql = "INSERT INTO user_tbl (first_name, last_name, first_name_katakana, last_name_katakana, tel_no, zip_code, prefecture, address1, address2, birthday, , mail, , introduction, profile_icon) VALUES ('"+username+"', '"+first_name+"', '"+last_name+"', '"+first_name_furigana+"', '"+last_name_furigana+"', '"+tel_no+"', '"+zip_code+"', '"+prefecture+"', '"+address1+"', '"+address2+"', '"+date_object+"', '"+mail+"', '"+introduction+"', '"+new_profile_icon+"');"
